                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    ...
                    final filteredStations = chargingStations.where((station) {
                      final stationData = station.data() as Map<String, dynamic>;
                    ...
                    final filteredByChargerType = selectedChargerType.isNotEmpty
                        ? filteredStations.where((station) =>
                    (station.data() as Map<String, dynamic>)['chargerType'] == selectedChargerType)
                        .toList()
                        : filteredStations;

                    // Apply charging speed filter
                    final filteredByChargingSpeed = selectedChargingSpeed.isNotEmpty
                        ? filteredByChargerType.where((station) =>
                    (station.data() as Map<String, dynamic>)['chargingSpeed'] == selectedChargingSpeed)
                        .toList()
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final geoPoint = chargingStationData['location'] as GeoPoint;
                        final String address = chargingStationData['address'];
                        final String chargerType = chargingStationData['chargerType'];
                        final String chargingSpeed = chargingStationData['chargingSpeed'];
                              ...
                              TextButton(
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => EditChargingStationPage(
